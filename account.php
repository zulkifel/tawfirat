...
header("location:account.php?do=continue-add-account");
exit();
}
...
<div class="container " style="font-family: 'Cairo', sans-serif;" >
	 ...
	 <br><h4 style="color: #e99b3b" class="text-right"><u> معلومات الموقع :</u></h4>
 ...
 <div class="container " style="font-family: 'Cairo', sans-serif;" >
        <h3 class=" text-center titleh title-1"> تم إرسال رسالة الي بريك الالكتروني التي تحتوي علي رمز التحقق من ستة خانة </h3>
